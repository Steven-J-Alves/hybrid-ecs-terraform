...
# -----------------------------------------------------------------------------
# Postgres deferred to the dedicated `data/` stack (see hybrid-ecs-terraform/data/).
# Apps arrancam sem persistência (in-memory) enquanto validamos rede+cluster+hybrid.
# Descomentar (e migrar para o data/ stack) quando o setup híbrido estiver estável.
# -----------------------------------------------------------------------------
