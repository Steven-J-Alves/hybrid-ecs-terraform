...
variable "command" {
  description = "Custom command to start the task"
  type        = string
  default     = "[]"
}

variable "environmentFiles" {
  description = "The environment files with variables"
  type        = string
  default     = "[]"
...
variable "network_mode" {
  description = "AWSVPC or Bridge Mode"
  type        = string
}

variable "linuxParameters" {
  description = "Linux Features Params"
  type        = map(any)
  default     = {}
}
